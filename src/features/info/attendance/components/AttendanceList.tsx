...
export const AttendanceList = ({
    ...
    const monthList: string[] = Array.from(new Set(attendance?.map(el => moment(el.scheduleDate).format("YYYY년 M월"))));
                ...
                <React.Fragment key={index}>
                    ...
                    >
                        <div>
                            ...
                            attendance
                                ?.filter((item: AttendanceMyResultRes) => moment(item.scheduleDate).format("YYYY년 M월") === month)
