        ...
        <Modal isOpen={isOpen}>
            ...
            <Modal.Footer>
              <div className="modalBtn__wrapper">
                <Modal.Button
                  onClick={rejectAbsence}
                  size="lt"
                  backgroundColor={COLORS.whitegrey}
                  color={COLORS.lightBackground}
                >{ABSENT_REQUEST_MODAL.btn.reject}</Modal.Button>
                <Modal.Button
                  onClick={acceptAbsence}
                  size="rt"
                  backgroundColor={COLORS.lightBackground}
                  color={COLORS.white}
                >{ABSENT_REQUEST_MODAL.btn.accept}</Modal.Button>
              </div>
            </Modal.Footer>
        </Modal>
        </>
